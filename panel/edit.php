                ...
                <div class="col-md-4">
                    ...
                    <form method="post" action="inc/queries/edit.php?id=<?php echo $data['id']; ?>">
                        ...
                        <div class="form-group">
                            <input type="text" name="number" id="number" class="<?php echo $error; ?> form-control form-control-lg" placeholder="Number here" value="<?php echo $data['number']; ?>">
                        </div>
                        <div class="form-group">
                            <input type="text" name="number2" id="number2" class="<?php echo $error; ?> form-control form-control-lg" placeholder="Number 2 here" value="<?php echo $data['number2']; ?>">
                        </div>
